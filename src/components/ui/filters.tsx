                  ...
                  <CommandItem
                    ...
                    onSelect={() => {
                      if (isMultiSelect) {
                        ...
                        if (field.onValueChange) {
                          field.onValueChange([] as Array<T>)
                        } else {
                          onChange([] as Array<T>)
                        }
                      }
                    ...
                    <CommandItem
                      ...
                      onSelect={() => {
                        if (isMultiSelect) {
                          ...
                          if (field.onValueChange) {
                            field.onValueChange([option.value] as Array<T>)
                          } else {
                            onChange([option.value] as Array<T>)
                          }
                          onClose?.()
                        }
                      }}
      ...
      return (
        <div className="flex items-center" data-slot="filters-item">
          <FilterInput
            type="time"
            value={startTime}
            onChange={(e) => onChange([e.target.value, endTime] as Array<T>)}
          ...
          <FilterInput
            type="time"
            value={endTime}
            onChange={(e) => onChange([startTime, e.target.value] as Array<T>)}
            onInputChange={field.onInputChange}
            className={field.className}
            field={field}
          />
    ...
    return (
      ...
      >
        <FilterInput
          type="date"
          value={startDate}
          onChange={(e) => onChange([e.target.value, endDate] as Array<T>)}
          onInputChange={field.onInputChange}
        ...
        <FilterInput
          type="date"
          value={endDate}
          onChange={(e) => onChange([startDate, e.target.value] as Array<T>)}
          onInputChange={field.onInputChange}
          className={cn('w-24', field.className)}
          field={field}
        />
      ...
      return (
        <div className="flex items-center" data-slot="filters-item">
          <FilterInput
            type="number"
            value={minVal}
            onChange={(e) => onChange([e.target.value, maxVal] as Array<T>)}
            onInputChange={field.onInputChange}
          ...
          <FilterInput
            type="number"
            value={maxVal}
            onChange={(e) => onChange([minVal, e.target.value] as Array<T>)}
            onInputChange={field.onInputChange}
    ...
    (fieldKey: string) => {
      ...
      if (field && field.key) {
          ...
          (field.type === 'daterange'
            ...
            : field.type === 'numberrange'
              ...
              : field.type === 'boolean'
                ? 'is'
                : 'is')
        let defaultValues: Array<unknown> = []
        ...
        if (
          ...
          defaultValues = [field.min || 0, field.max || 100] as Array<unknown>
        } else if (field.type === 'boolean') {
          defaultValues = [false] as Array<unknown>
              ...
              <Command>
                {selectedFieldForOptions ? (
                  ...
                  <SelectOptionsPopover<T>
                    ...
                    values={tempSelectedValues as Array<T>}
                    onChange={(values) => {
